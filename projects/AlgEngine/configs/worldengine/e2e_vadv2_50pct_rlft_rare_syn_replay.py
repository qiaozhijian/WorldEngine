"""
RLFT Rare Syn Replay: RL fine-tuning with synthetic replay rollouts, excluding real failures.
Key: customized_filter="v2", include_real_failures=False.
...
data = dict(
    ...
    train=dict(
        ...
        customized_filter="v2",
        include_real_failures=False,
    ),
    val=dict(
        type=dataset_type,
        file_client_args=file_client_args,
