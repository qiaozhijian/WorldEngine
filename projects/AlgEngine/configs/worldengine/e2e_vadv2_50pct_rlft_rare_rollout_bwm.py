"""
RLFT Rare Rollout BWM: RL fine-tuning with multi-source augmented synthetic rollouts.
Key: 4 synthetic_folder_names (collision + augmented collision/ep/offroad), customized_filter="v1".
